...
import {hero, heroM, menu, close} from './assets'
        ...
        <div className="flex justify-between items-start w-[540px] sm:py-4 py-0">
          ...
          <div className="sm:flex hidden items-center relative pb-[36px]" onMouseEnter={handleHover} onMouseLeave={mouselLeave}>
            ...
            <div className='p-6 absolute top-[0px] right-[0] bg-white dropdown slide-bottom flex flex-col items-start justify-between h-[170px]' >
              <div className='flex items-center justify-between cursor-pointer'>
                ...
                <p className='text-[14px] text-mediumGray '>Todo List</p>
              </div>
              <div className='flex items-center justify-between cursor-pointer'>
                <div className='w-4 mr-2'>
                ...
                <p className='text-[14px] text-mediumGray '>Calendar</p>
              </div>
              <div className='flex items-center justify-between cursor-pointer'>
                <div className='w-4 mr-2'>
                ...
                <p className='text-[14px] text-mediumGray '>Reminders</p>
              </div>
              <div className='flex items-center justify-between cursor-pointer'>
                <div className='w-4 mr-2'>
                ...
                <p className='text-[14px] text-mediumGray '>Planning</p>
              </div>
            </div>}
          </div>

          <div className="sm:flex hidden items-center relative pb-[36px]" onMouseEnter={handleHoverB} onMouseLeave={mouselLeaveB}>
          <div className='relative'>
              <p  className='text-[14px] relative text-mediumGray hover:text-almostBlack cursor-pointer font-[700] mr-1'>Company</p>
            </div>
            <svg className={`${visibleB ? 'arrow' : ''}`} width="10" height="6" xmlns="http://www.w3.org/2000/svg"><path stroke="#686868" stroke-width="1.5" fill="none" d="m1 1 4 4 4-4"/></svg>
            {visibleB && 
            <div className='p-6 absolute top-[0px] left-[0] bg-white dropdown slide-bottom flex flex-col items-start justify-between h-[130px]' >
              <div className='sm:flex hidden items-center justify-between'>
                <p className='text-[14px] text-mediumGray w-[70px] cursor-pointer'>History</p>
              </div>
              <div className='sm:flex hidden items-center justify-between'>
                <p className='text-[14px] text-mediumGray w-[70px] cursor-pointer'>Our Team</p>
              </div>
              <div className='sm:flex hidden items-center justify-between'>
                <p className='text-[14px] text-mediumGray w-[70px] cursor-pointer'>Blog</p>
              </div>
            </div>}
          </div>
          <p className='sm:flex hidden text-[14px] text-mediumGray hover:text-almostBlack font-[700] cursor-pointer'>Careers</p>
          <p className='sm:flex hidden text-[14px] text-mediumGray hover:text-almostBlack font-[700] cursor-pointer'>About</p>
          ...
          <div className="sm:hidden flex flex-1 justify-end items-center">
                <img
                  ...
                  className={`${
                    !toggle ? "static" : "fixed"
                  } z-50 w-[28px] h-[28px] top-6 object-contain`}
                  onClick={() => setToggle(!toggle)} />
                {toggle && <div className='menu-overlay'></div>}
                <div
                  className={`${
                    !toggle ? "hidden" : "flex"
                  } p-6 pt-20 bg-almostWhite flex-col h-[100vh] w-[65%] fixed top-0 right-0 min-w-[140px] sidebar z-10`}
                >
                  <ul className=" list-none flex justify-start items-start flex-1 flex-col h-[486px]">
                     <li onClick={() => setVisible(!visible)} className='flex flex-col'>
                      <div  className='flex items-center justify-start'>
                        <p className='text-[16px] relative text-mediumGray hover:text-almostBlack cursor-pointer font-[700] mr-2'>Features</p>
                        <svg className={`${visible ? 'arrow' : ''}`} width="10" height="6" xmlns="http://www.w3.org/2000/svg"><path stroke="#686868" stroke-width="1.5" fill="none" d="m1 1 4 4 4-4"/></svg>
                      </div>
                        {visible && 
                        <div className='p-6 ml-2 bg-almostWhite flex flex-col items-start justify-between h-[170px]' >
                          <div className='flex items-center justify-between cursor-pointer'>
                              <div className='w-4 mr-2'>
                              <svg width="14" height="16" xmlns="http://www.w3.org/2000/svg"><path d="M14 3v12a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1h1V1a1 1 0 1 1 2 0v1h2V1a1 1 0 1 1 2 0v1h2V1a1 1 0 0 1 2 0v1h1a1 1 0 0 1 1 1Zm-2 3H2v1h10V6Zm0 3H2v1h10V9Zm0 3H2v1h10v-1Z" fill="#726CEE"/></svg>
                              </div>
                     ...
                     <li onClick={() => setVisibleB(!visibleB)} className='flex flex-col mt-4'>
                      <div className='flex items-center justify-start'>
                        <p className='text-[16px] relative text-mediumGray hover:text-almostBlack cursor-pointer font-[700] mr-2'>Company</p>
                        <svg className={`${visibleB ? 'arrow' : ''}`} width="10" height="6" xmlns="http://www.w3.org/2000/svg"><path stroke="#686868" stroke-width="1.5" fill="none" d="m1 1 4 4 4-4"/></svg>
                      </div>
                      {visibleB && 
                        <div className='p-6 ml-2 bg-almostWhite flex flex-col items-start justify-between h-[150px]' >
                          <div className='flex items-center justify-between cursor-pointer'>
                            <p className='text-[14px] text-mediumGray '>History</p>
                          </div>
                          <div className='flex items-center justify-between cursor-pointer'>
                            <p className='text-[14px] text-mediumGray '>Our Team</p>
                          </div>
                          <div className='flex items-center justify-between cursor-pointer'>
                            <p className='text-[14px] text-mediumGray '>Blog</p>
                          </div>
                          
                        </div>}
                     </li>
                     
                      <li className={`mt-4 text-[16px] relative text-mediumGray hover:text-almostBlack cursor-pointer font-[700]`}><a>Careers</a></li>
                      <li className={`mt-4 text-[16px] relative text-mediumGray hover:text-almostBlack cursor-pointer font-[700]`}><a>About</a></li>
                      <div className='flex flex-col mt-8 w-full'>

                      <button className='text-mediumGray hover:text-almostBlack text-[14px] font-[500]'>Login</button>
                      <button className='text-mediumGray hover:text-almostBlack text-[14px] font-[500] rounded-xl py-1 px-3 border-solid border-[2px] border-mediumGray hover:border-almostBlack mt-4'>Register</button>
                      </div>
                  </ul>
                </div>
              </div>
          ...
          <div className="sm:flex hidden justify-between items-center w-[160px] pb-6">
            <button className='text-mediumGray hover:text-almostBlack text-[14px] font-[500]'>Login</button>
            <button className='text-mediumGray hover:text-almostBlack text-[14px] font-[500] rounded-xl py-1 px-3 border-solid border-[2px] border-mediumGray hover:border-almostBlack'>Register</button>
          </div>
      </nav>
      
      <main className='flex sm:flex-row flex-col-reverse justify-between items-start w-full sm:pl-40 sm:pr-28'>
        <div className='sm:my-32 my-10 flex flex-col sm:justify-start sm:items-start justify-start items-center'>
          <h1 className='sm:text-[80px] text-[36px] sm:text-left text-center sm:w-[550px] w-[360px] text-almostBlack font-[900] sm:leading-[82px]'>Make <br className='sm:flex hidden'/> remote work</h1>
          <p className='sm:text-[18px] text-[16px] text-mediumGray sm:text-left text-center font-[500] sm:w-[450px] w-[350px] sm:mt-10 mt-2'>Get your team in sync, no matter your location. Streamline processes, create team rituals, and watch productivity soar.</p>
          <button className='bg-almostBlack hover:bg-transparent text-almostWhite hover:text-almostBlack text-[14px] font-[700] rounded-xl py-2 px-6 border-solid border-[2px] border-mediumGray hover:border-almostBlack sm:mt-10 mt-5'>Learn More</button>
          <div className='flex items-center justify-between sm:w-[480px] sm:mt-32 mt-12'>
        ...
        <div className='flex sm:hidden w-full'>
          <img src={heroM} className='w-full'/>
        </div>
      </main>
    </div>
  )
